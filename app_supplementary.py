...
from custom_tools import get_information_on_patient, explain_prediction_diabetes_method, explain_predictions_diabetes, calculate_diabetes_risk, get_qrisk3_information, calculate_deephit, important_deephit_features, get_nice_guidelines, evaluate_heart_risk, get_info, plot_feature_importance_heart_risk, counterfactual_CVD_risk, df_to_string, calculate_Qrisk_score, calculate_framingham_score
