...
from custom_tools import (
    ...
    get_nice_guidelines_stroke, plot_feature_importance_heart_risk,
    counterfactual_CVD_risk_ap, calculate_Qrisk_score, get_feature_importance,
    get_stroke_infosheet, get_feature_importance_af, calculate_stroke_risk_score,
    counterfactual_stroke_risk
)

config = get_openai_config()

# FILE
QUESTION_FILE = './resources/documents/Questions_by_topic_stroke.xlsx'

# Include all tools
TOOL_LIST = [get_stroke_infosheet, get_nice_guidelines_stroke, get_feature_importance_af, calculate_stroke_risk_score, counterfactual_stroke_risk]

# Tool descriptions for logging
tool_names = {
    'calculate_stroke_risk_score': 'a method that calculates the stroke risk score for a patient. Only call this tool if the question already contains a patient id such as person_af_0. Otherwise use the infosheet or guideline tools.',
    'get_nice_guidelines_stroke': 'a document titled Atrial fibrillation: diagnosis and management Overview This guideline covers diagnosing and managing atrial fibrillation in adults.  It includes guidance on providing the best care and treatment for people with atrial fibrillation, including assessing and managing risks of stroke and bleeding.',
    'counterfactual_stroke_risk': 'a Counterfactual stroke risk estimation method risk estimation method',
    'get_stroke_infosheet': 'This infosheet provides a comprehensive overview of the prediction model, including its methodology, a breakdown of traditional and additional risk factors, detailed validation results, and performance metrics.',
    'get_feature_importance_af': 'This provides feature importnace for specific people when you supply the name to the function (e.g. person_af_0). Only used for specific people'
}
